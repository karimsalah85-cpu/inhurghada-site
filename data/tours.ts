...
const tourCatalog: Array<Omit<Tour, "destinationSlug"> & { destinationSlug?: DestinationSlug }> = [
  ...
  {
    slug: "turkish-bath-spa", title: "Turkish Hammam and Spa Experience", image: "/images/hero.jpg", currency: "EUR", price: "25", priceUnit: "per person", rating: "New", reviews: "New", location: "Hurghada, Egypt", duration: "60–120 Minutes", category: "Wellness", badge: "New", bookingMode: "direct", participantPricing: { adults: 25 }, packageName: "Turkish Hammam Ritual – 120 Minutes", packageDescription: "An authentic Turkish hammam designed to revive body and spirit: sauna, steam and jacuzzi, a loofah scrub with Moroccan soap, an indulgent foam scrub, a soothing full-body massage and a nourishing face mask.", packagePrice: "50", packageLabel: "Per person, 120 minutes",
    description: "Choose a Relaxing Massage in 60 or 90 minutes, or the full Turkish Hammam ritual: sauna, steam and jacuzzi followed by a loofah scrub with Moroccan soap, an indulgent foam scrub, a soothing full-body massage and a nourishing face mask.", highlights: ["Relaxing Massage – 60 minutes (25 EUR)", "Relaxing Massage – 90 minutes (40 EUR)", "Turkish Hammam Ritual – 120 minutes (50 EUR)", "Sauna, steam and jacuzzi circuit", "Traditional loofah and Moroccan soap cleansing", "Luxurious foam scrub ritual", "Full-body massage for tension release", "Refreshing face mask"], included: ["Treatments listed in the confirmed package", "Towel and spa facilities", "Tea or water when provided", "Transfer in the confirmed pickup zone"], notIncluded: ["Extra treatments", "Personal products", "Transfers outside the confirmed zone"], notes: ["Relaxing Massage: 60 minutes for 25 EUR or 90 minutes for 40 EUR, per person.", "Turkish Hammam Ritual: 120 minutes for 50 EUR, per person.", "Open daily from 9:00 AM to 11:00 PM.", "Tell the spa about pregnancy, injuries, allergies or medical conditions before booking.", "Minimum age, privacy arrangements and cancellation terms are confirmed in advance."], availableTimes: ["Daily, 9:00 AM – 11:00 PM"], notSuitableFor: ["Guests with medical conditions not cleared for heat or massage treatments"], whatToBring: ["Swimwear", "Dry clothes", "Any essential medication"], seoTitle: "Turkish Hammam and Relaxing Massage in Hurghada", metaDescription: "Book a Relaxing Massage (60 min for 25 EUR, 90 min for 40 EUR) or the full Turkish Hammam ritual (120 min for 50 EUR) in Hurghada, open daily 9:00 AM–11:00 PM."
  },
  {
