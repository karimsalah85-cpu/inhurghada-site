...
export const tours: Tour[] = [
  ...
  {
    slug: "dolphin-house-snorkeling", title: "Dolphin House Snorkeling Boat Trip Hurghada", image: "/images/hurghada-snorkeling-reef-panorama.jpeg",
  ...
  {
    slug: "hula-hula-island-snorkeling", title: "Hula Hula Island Boat Trip & Snorkeling Hurghada", image: "/images/hurghada-island-beach-loungers.jpeg",
  ...
  },
  {
    ...
    price: "150", rating: "New", reviews: "New", location: "Hurghada Marina", duration: "Approximately 4 Hours", category: "Private Speedboat", badge: "Premium", bookingMode: "direct", pricingMode: "per-booking", priceUnit: "per private boat", participantPricing: { adults: 150 }, ageBands: { adults: "Passengers in your private group", children: "", infants: "" },
    description: "Enjoy an exclusive private speedboat experience from Hurghada to Magawish Island for your group, with a coral-reef snorkeling stop, island free time and round-trip hotel transfers.",
    highlights: ["Exclusive private speedboat for your group", "Free time on Magawish Island", "Snorkeling at a vibrant coral reef", "Experienced captain and all fuel included", "Hurghada hotel pickup and drop-off"],
    included: ["Hotel pickup and drop-off from Hurghada", "Exclusive private speedboat for your group", "Experienced captain", "Fuel and all boat expenses", "Snorkeling stop at a vibrant coral reef", "Snorkeling equipment", "Free time on Magawish Island", "Life jackets and safety equipment", "Approximately four-hour private speedboat experience"],
    notIncluded: ["Magawish Island entrance fee ($10 per person, paid separately)", "Meals and beverages", "Personal expenses", "Professional photography or videos"],
    notes: ["Bring your passport or a copy.", "The Magawish Island entrance fee is $10 per person and is paid separately.", "The boat experience lasts approximately four hours, excluding hotel transfers.", "Pickup time varies by hotel location and is confirmed by WhatsApp.", "Sea conditions may affect the route and order of activities.", "Snorkeling is suitable for beginners and experienced swimmers."],
    itinerary: ["Pickup from your Hurghada hotel", "Private transfer to Hurghada Marina", "Private speedboat cruise", "Guided coral-reef snorkeling stop", "Magawish Island · free time", "Private speedboat return to the marina", "Hotel drop-off"],
    packageName: "Private Magawish Speedboat", packageDescription: "One private speedboat for your group with Hurghada transfers, snorkeling and Magawish Island free time.", packagePrice: "150", packageLabel: "Private boat total", availableTimes: ["Departure time confirmed by WhatsApp"], whatToBring: ["Passport or a copy", "Comfortable swimwear", "Towel", "Sunscreen", "Sunglasses", "Sun hat", "Cash for the island entrance fee"], seoTitle: "Private Speedboat to Magawish Island from Hurghada", metaDescription: "Book a private four-hour speedboat to Magawish Island from Hurghada for $150 per boat, with hotel transfers, snorkeling equipment and island free time."
  },
  {
