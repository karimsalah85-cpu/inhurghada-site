...
const tourCatalog: Array<Omit<Tour, "destinationSlug"> & { destinationSlug?: DestinationSlug }> = [
  ...
  {
    slug: "senzo-transfer", title: "Private Transfer To and From Senzo Mall Hurghada", image: "/images/placeholders/sea-activity.svg", price: "15", priceUnit: "per vehicle", pricingMode: "per-booking", participantPricing: { adults: 15 }, rating: "New", location: "Hurghada, Egypt", duration: "Flexible", category: "Shopping Transfer", badge: "New",
