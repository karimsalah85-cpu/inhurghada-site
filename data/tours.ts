...
export const tours: Tour[] = [
...

  {
    ...
    description: "Discover the crystal-clear waters of Mahmya Island in the Giftun Island National Park. Relax on white sand, swim in turquoise water, and enjoy a premium island day from Hurghada.", availableTimes: ["08:00"],
  ...
  },
  {
    ...
    description: "Private door-to-door transport between your Hurghada hotel and Senzo Mall for shopping, dining, and entertainment, with flexible return times.", highlights: ["Private vehicle", "Hotel pickup", "Flexible return time", "Air-conditioned car"], included: ["Private transfer", "Driver", "Fuel and parking"], notIncluded: ["Shopping and meals"], notes: ["Confirm your preferred return time when booking."], packageName: "Senzo Mall private transfer", packageDescription: "Simple door-to-door transport for shopping and dining.", packagePrice: "15", packageLabel: "From price", availableTimes: ["Preferred time confirmed by WhatsApp"],
  },
