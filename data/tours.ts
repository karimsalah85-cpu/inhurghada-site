...
const tourCatalog: Array<Omit<Tour, "destinationSlug"> & { destinationSlug?: DestinationSlug }> = [
  ...
  },
  {
    ...
    metaDescription: "Book an SSI Basic Diver try-scuba experience in Jeddah: theory, confined-water skills, equipment and a 30–45 minute open-water dive, now SAR 468 (was SAR 550).",
