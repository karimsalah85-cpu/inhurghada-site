...
const tourCatalog: Array<Omit<Tour, "destinationSlug"> & { destinationSlug?: DestinationSlug }> = [
  ...
  {
    slug: "turkish-bath-spa", title: "Turkish Hammam and Spa Experience", image: "/images/owned/red-sea-coast.jpg", currency: "EUR", price: "25", priceUnit: "per person", rating: "New", reviews: "New", location: "Hurghada, Egypt", duration: "60–120 Minutes", category: "Wellness", badge: "New", bookingMode: "direct", participantPricing: { adults: 25 },
