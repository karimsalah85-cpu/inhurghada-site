...
const tourCatalog: Array<Omit<Tour, "destinationSlug"> & { destinationSlug?: DestinationSlug }> = [
  ...
  {
    slug: "hurghada-airport-transfer", title: "Hurghada Airport Private Transfer", image: "/images/placeholders/sea-activity.svg", price: "15", priceUnit: "per vehicle", pricingMode: "per-booking", participantPricing: { adults: 15 }, pricingLockedToCode: true, rating: "5.0", reviews: "New", location: "Hurghada International Airport", duration: "Flexible", category: "Airport Transfer", badge: "Best Value",
    seoTitle: "Private Hurghada Airport Transfer | Hotel Pickup, Price Per Vehicle", metaDescription: "Book a private Hurghada Airport transfer to hotels in Hurghada, El Gouna, Sahl Hasheesh, Makadi Bay, Soma Bay and the southern Red Sea coast. Price is per vehicle, shown before booking.",
    description: "Private, fixed-price airport transfers between Hurghada International Airport and your hotel. The price is per vehicle, per journey — not per person — and the vehicle is matched to your passengers and luggage. From $15 per vehicle within Hurghada.", highlights: ["Price per vehicle, shown before you book", "Vehicle matched to passengers and luggage", "Meet and greet", "Child seats on request", "Flight number collected for airport pickups", "Larger vehicles for families and groups"], included: ["Private vehicle for your group", "Driver", "Fuel and parking"], notIncluded: ["Additional stops", "Return journey unless a round trip is booked"], notes: ["Adults, children and infants all count toward vehicle seating capacity.", "Declare large or unusual luggage so the correct vehicle is sent.", "Child, infant and booster seats must be requested in advance and are subject to availability.", "Send your flight number and hotel name when booking."], packageName: "Private airport transfer (per vehicle)", packageDescription: "From $15 per vehicle within Hurghada. Sahl Hasheesh, Makadi Bay and El Gouna from $20; Soma Bay from $30; southern Red Sea coast priced by distance.", packagePrice: "15", packageLabel: "Per vehicle, one way", availableTimes: ["Time confirmed from your flight details"],
  },
  {
    slug: "senzo-transfer", title: "Private Transfer To and From Senzo Mall Hurghada", image: "/images/placeholders/sea-activity.svg", price: "15", priceUnit: "per vehicle", pricingMode: "per-booking", participantPricing: { adults: 15 }, pricingLockedToCode: true, rating: "New", location: "Hurghada, Egypt", duration: "Flexible", category: "Shopping Transfer", badge: "New",
    seoTitle: "Senzo Mall Transfer from Hurghada Hotels | Price Per Vehicle", metaDescription: "Private transfer between your Hurghada hotel and Senzo Mall for shopping, dining and entertainment. Priced per vehicle by group size.",
    description: "One-way private Senzo Mall transfer, priced per vehicle — not per person. 1–3 passengers travel by private car from $15; 4–10 by private van from $30. Makadi Bay, Soma Bay, El Gouna and Sahl Hasheesh add $7.", highlights: ["Price per vehicle, shown before you book", "Vehicle matched to your group size", "Private vehicle", "Hotel pickup", "Flexible pickup time", "Air-conditioned"], included: ["Private transfer", "Driver", "Fuel and parking"], notIncluded: ["Return journey", "Travel bags", "Shopping and meals"], notes: ["Price is per vehicle, one way — not per person.", "1–3 passengers travel by private car; 4–10 by private van.", "Travel bags are not carried on this service.", "Book each direction separately if you need a return journey."], packageName: "Senzo Mall one-way transfer (per vehicle)", packageDescription: "From $15 per vehicle within Hurghada; add $7 for Makadi Bay, Soma Bay, El Gouna, or Sahl Hasheesh.", packagePrice: "15", packageLabel: "Per vehicle, one way", availableTimes: ["Preferred time confirmed by WhatsApp"],
  },
  ...
  {
    slug: "horse-riding-sea-desert", title: "Hurghada Desert and Sea Horse Riding with Optional Swimming", image: "/images/placeholders/horse-riding.svg",
  ...
  },
  {
    ...
    participantPricing: { adults: 156.75 },
    ...
    metaDescription: "Book an SSI Basic Diver try-scuba experience in Jeddah: theory, confined-water skills, equipment and a 30–45 minute open-water dive, now USD 156.75 (was USD 165).",
  ...
  },
  {
    ...
    metaDescription: "Book a two-dive guided boat trip for certified divers in Jeddah, exploring wreck and coral sites near Al-Haddad Scuba Shop, now USD 114 per person (was USD 120), including tanks and snacks.",
  ...
  },
  {
    ...
    badge: "New",
    bookingMode: "direct",
    participantPricing: { adults: 30.40, youth: 15.20, infants: 0 },
    ...
    metaDescription: "Book the Shorouk Sat Jeddah yacht sunset cruise in Obhur Bay, now USD 30.40 per adult (was USD 32), with sandwiches, beverages and three viewing decks.",
  ...
  },
  {
    ...
    participantPricing: { adults: 104.50 },
    operatingWeekdays: [0, 1, 2, 3, 4, 5, 6],
    ...
    metaDescription: "Book Al-Haddad Scuba's daily Bayada snorkeling boat trip from Jeddah: a rotating choice of Red Sea reef sites with a professional instructor, plus equipment, snacks and drinks, now USD 104.50 per person (was USD 110).",
