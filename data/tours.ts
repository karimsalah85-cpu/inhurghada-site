...
export const tours: Tour[] = [
...

  {
    ...
    description: "Set sail from Hurghada to the famous Dolphin House area, home to wild dolphins. Enjoy two coral-reef snorkeling stops, lunch and drinks aboard a comfortable yacht, with hotel transfers included.",
    highlights: ["Look for wild dolphins in their natural Red Sea habitat", "Enjoy two snorkeling stops at colorful coral reefs", "Relax on a spacious yacht between activities", "Enjoy a freshly prepared lunch and drinks onboard", "Travel with a professional crew and included safety equipment"],
    included: ["Hotel pickup and drop-off in Hurghada", "Luxury yacht cruise", "Dolphin House visit", "Two snorkeling stops", "Snorkeling equipment", "Lunch onboard", "Water, soft drinks, tea and coffee", "Professional crew", "Life jackets and safety equipment"],
  ...
  },
  {
    ...
    participantPricing: { adults: 25, youth: 15, infants: 0 }, ageBands: { adults: "Adults (ages 11+)", children: "Children (ages 4–10)", infants: "Infants (ages 0–3)" },
    description: "Escape to the Red Sea on a full-day Hula Hula Island snorkeling trip from Hurghada. Cruise by luxury yacht, relax for an hour on the island, explore two coral reefs and enjoy lunch and soft drinks onboard.",
    highlights: ["Relax for one hour on Hula Hula Island", "Cruise across the Red Sea on a luxury yacht", "Snorkel at two vibrant coral-reef locations", "Enjoy a fresh buffet lunch and unlimited soft drinks", "Hotel pickup and return included from Hurghada"],
    included: ["Hotel pickup and drop-off in Hurghada", "Luxury yacht cruise", "Hula Hula Island access", "Two snorkeling stops", "Snorkeling equipment", "Expert snorkeling guide", "Fresh buffet lunch", "Unlimited soft drinks", "Life jackets", "Onboard crew assistance"],
    ...
    itinerary: ["Pickup from your Hurghada hotel", "Transfer to the marina and luxury yacht departure", "First guided snorkeling stop", "Hula Hula Island · approximately one hour of beach and swimming time", "Fresh buffet lunch and soft drinks onboard", "Second guided snorkeling stop", "Return cruise, marina arrival and hotel drop-off"],
    packageName: "Hula Hula Island Boat Trip", packageDescription: "Eight-hour island and snorkeling yacht trip with two reef stops, lunch, drinks and Hurghada hotel transfers.", packagePrice: "25", packageLabel: "Adult", availableTimes: ["Morning pickup confirmed by WhatsApp"], whatToBring: ["Passport or a copy", "Swimwear", "Beach towel", "Sunscreen", "Sunglasses and sun hat"], seoTitle: "Hula Hula Island Boat Trip and Snorkeling from Hurghada", metaDescription: "Book an eight-hour Hula Hula Island boat trip from Hurghada with two snorkeling stops, lunch, drinks, equipment and hotel transfers."
  },
  {
    slug: "paradise-island", title: "Paradise Island Yacht Cruise, Lunch and Snorkeling", image: "/images/placeholders/sea-activity.svg",
  ...
  {
    slug: "royal-seascope-submarine", title: "Royal Seascope Semi-Submarine", image: "/images/placeholders/sea-activity.svg", price: "17.60", rating: "New", reviews: "New", location: "Hurghada Marina", duration: "About 3 Hours", category: "Family Sea Activity", badge: "New", bookingMode: "direct", participantPricing: { adults: 17.60 },
  ...
  {
    slug: "horse-riding-sea-desert", title: "Hurghada Desert and Sea Horse Riding with Optional Swimming", image: "/images/placeholders/sea-activity.svg",
  ...
  {
    slug: "sahl-hasheesh-horse-riding", title: "Sahl Hasheesh Desert and Sea Horse Ride with Optional Swimming", image: "/images/placeholders/sea-activity.svg",
  ...
  {
    slug: "cairo-day-trip-flight", title: "Cairo and Giza Day Trip by Plane", image: "/images/placeholders/sea-activity.svg", price: "224.00", rating: "New", reviews: "New", location: "Cairo and Giza, Egypt", duration: "Full Day", category: "Cultural Day Trip", badge: "Premium", bookingMode: "direct", participantPricing: { adults: 224 },
  ...
  {
    slug: "el-gouna-city-boat-tour", title: "El Gouna City, Lagoon Boat and Tuk-Tuk Tour", image: "/images/placeholders/sea-activity.svg", price: "36.80", rating: "New", reviews: "New", location: "El Gouna, Egypt", duration: "About 5 Hours", category: "City Tour", badge: "New", bookingMode: "direct", participantPricing: { adults: 36.80 },
  ...
  {
    slug: "turkish-bath-spa", title: "Turkish Bath and Spa Experience", image: "/images/placeholders/sea-activity.svg", price: "18.40", rating: "New", reviews: "New", location: "Hurghada, Egypt", duration: "About 2–3 Hours", category: "Wellness", badge: "New", bookingMode: "direct", participantPricing: { adults: 18.40 },
  ...
  {
    slug: "dolphin-house-marsa-alam", listingStatus: "paused", destinationSlug: "marsa-alam", currency: "EUR", title: "Dolphin House Full-Day Snorkeling Boat Trip from Marsa Alam", image: "/images/placeholders/dolphin-house.svg", price: "99", rating: "New", reviews: "New", location: "Marsa Alam Marina, Marsa Alam", duration: "Full day", category: "Snorkeling", badge: "New", bookingMode: "direct", priceUnit: "per person", participantPricing: { adults: 99, youth: 50 }, ageBands: { adults: "Adult price — age boundary pending confirmation", children: "Child price — age boundary pending confirmation", infants: "No infant price has been confirmed" }, availableTimes: ["07:00 pickup · 08:30 boat departure"], operatingWeekdays: [1, 5], bookingCutoff: { daysBefore: 1, localTime: "18:00", timeZone: "Africa/Cairo", assumption: true }, departureMarina: "Marsa Alam Marina", bookingBlocker: "Child age range and eligible pickup zones must be confirmed before activation.",
    description: "Travel from an eligible Marsa Alam-area hotel to Marsa Alam Marina for a full-day boat journey to the Dolphin House habitat area, with two snorkeling sessions and lunch. Dolphin sightings and water entry are never guaranteed and depend on wildlife behaviour, sea conditions and crew safety instructions.", highlights: ["Monday and Friday departures", "Two snorkeling sessions", "Lunch on the boat", "Known dolphin habitat area without a sighting guarantee", "Marsa Alam-area pickup subject to zone confirmation"], included: ["Transfer from an eligible Marsa Alam-area hotel", "Boat trip from Marsa Alam Marina", "Two snorkeling sessions", "Lunch"], notIncluded: ["Personal expenses", "Any equipment not explicitly confirmed", "Remote-area pickup supplements if applicable"], notes: ["Pickup is included from eligible Marsa Alam-area hotels. The exact pickup time and any remote-area supplement are confirmed after the hotel location is provided.", "Do not touch, chase, feed or crowd wildlife. Follow the crew's instructions at all times.", "The route and snorkeling access may change with wildlife behaviour, weather, sea conditions and safety requirements.", "Bookings close at 18:00 Africa/Cairo time on the previous day; this precise time is an operational assumption requiring confirmation.", "Free cancellation is available up to 24 hours before departure unless supplier commitments have already become non-refundable.", "Child age range must be confirmed before publication."], itinerary: ["Hotel pickup at approximately 07:00", "Arrival at Marsa Alam Marina at approximately 08:00", "Boat departure at approximately 08:30", "Approximately one hour by boat to the Dolphin House area", "First snorkeling session", "Lunch on board", "Second snorkeling session", "Return to the marina at approximately 16:00", "Hotel return transfer follows marina arrival"], whatToBring: ["Passport or photo ID", "Swimwear", "Towel", "Sun protection", "Personal medication"], notSuitableFor: ["Guests unable to swim safely without the assistance they require", "Guests whose medical condition is incompatible with a full-day boat trip"], faqs: [{ question: "Are dolphins guaranteed?", answer: "No. Dolphin House is a known habitat area, but sightings and any opportunity to enter the water depend on wildlife behaviour, sea conditions and safety instructions." }, { question: "Which hotels include pickup?", answer: "Eligible hotel zones and any remote-area supplement must be confirmed after you provide the hotel location." }], seoTitle: "Dolphin House Snorkeling from Marsa Alam", metaDescription: "Review the Monday and Friday Dolphin House boat trip from Marsa Alam with two snorkeling sessions, lunch and eligible-area hotel transfer. Wildlife sightings are not guaranteed."
  },
  {
    slug: "marsa-mubarak-snorkeling", listingStatus: "paused", destinationSlug: "marsa-alam", currency: "EUR", title: "Marsa Mubarak Full-Day Snorkeling Boat Trip from Marsa Alam", image: "/images/placeholders/island-trip.svg", price: "60", rating: "New", reviews: "New", location: "Port Ghalib Marina, Marsa Alam", duration: "Full day", category: "Snorkeling", badge: "New", bookingMode: "direct", priceUnit: "per person", participantPricing: { adults: 60, youth: 40 }, ageBands: { adults: "Adult price — age boundary pending confirmation", children: "Child price — age boundary pending confirmation", infants: "No infant price has been confirmed" }, availableTimes: ["07:00 pickup · 08:30 boat departure"], operatingWeekdays: [0, 2, 3, 4, 6], departureMarina: "Port Ghalib Marina", bookingBlocker: "Child age range, pickup zones and booking cutoff must be confirmed before activation.",
    description: "Depart from Port Ghalib Marina for a full-day boat trip to Marsa Mubarak, with two snorkeling sessions and lunch. Turtles, dugongs and other wildlife are wild animals, so sightings cannot be guaranteed.", highlights: ["Operates daily except Monday and Friday", "Two snorkeling sessions", "Lunch and entrance fee included", "Port Ghalib Marina departure", "Natural wildlife encounters without guarantees"], included: ["Transfer from an eligible Marsa Alam-area hotel", "Boat trip", "Two snorkeling sessions", "Lunch", "Entrance fee"], notIncluded: ["Personal expenses", "Any equipment not explicitly confirmed", "Remote-area pickup supplements if applicable"], notes: ["Pickup is included from eligible Marsa Alam-area hotels. The exact pickup time and any remote-area supplement are confirmed after the hotel location is provided.", "Wildlife sightings depend on natural conditions and are not guaranteed.", "The route and snorkeling access depend on weather, sea conditions and safety instructions.", "The booking cutoff has not been supplied and must be confirmed before activation.", "Child age range must be confirmed before publication."], itinerary: ["Hotel pickup at approximately 07:00", "Arrival at Port Ghalib Marina at approximately 08:00", "Boat departure at approximately 08:30", "Approximately one hour by boat to Marsa Mubarak", "First snorkeling session", "Lunch on board", "Second snorkeling session", "Return to the marina at approximately 16:00", "Hotel return transfer follows marina arrival"], whatToBring: ["Passport or photo ID", "Swimwear", "Towel", "Sun protection", "Personal medication"], faqs: [{ question: "Are turtles or dugongs guaranteed?", answer: "No. Marsa Mubarak is a natural habitat and all wildlife sightings depend on natural conditions." }, { question: "Is the entrance fee included?", answer: "Yes, the supplied package includes the entrance fee." }], seoTitle: "Marsa Mubarak Snorkeling Boat Trip", metaDescription: "Review the Marsa Mubarak snorkeling boat trip from Port Ghalib, operating daily except Monday and Friday with lunch, entrance and eligible-area transfer."
  },
  {
    slug: "abu-dabbab-snorkeling", listingStatus: "paused", destinationSlug: "marsa-alam", currency: "EUR", title: "Abu Dabbab Beach Snorkeling Trip by Bus from Marsa Alam", image: "/images/placeholders/island-trip.svg", price: "50", rating: "New", reviews: "New", location: "Abu Dabbab Beach, Marsa Alam", duration: "Approximately 6 hours", category: "Snorkeling", badge: "New", bookingMode: "direct", priceUnit: "per person", participantPricing: { adults: 50, youth: 30 }, ageBands: { adults: "Adult price — age boundary pending confirmation", children: "Child price — age boundary pending confirmation", infants: "No infant price has been confirmed" }, availableTimes: ["07:00 pickup"], operatingWeekdays: [1, 3, 5], bookingCutoff: { daysBefore: 1, localTime: "18:00", timeZone: "Africa/Cairo", assumption: true }, bookingBlocker: "Child age range and eligible pickup zones must be confirmed before activation.",
    description: "Travel by bus or shared transfer to Abu Dabbab Beach for an easy-access snorkeling visit. The return journey begins at approximately 13:00. Sea turtles are often seen in the area, but sightings are not guaranteed.", highlights: ["Monday, Wednesday and Friday departures", "Easy beach access", "Suitable for families with normal swimming ability and supervision", "Beach entrance included", "Turtle sightings possible but never guaranteed"], included: ["Transfer from an eligible Marsa Alam-area hotel", "Abu Dabbab Beach entrance fee"], notIncluded: ["Lunch", "Personal expenses", "Optional equipment unless explicitly confirmed", "Remote-area pickup supplements if applicable"], notes: ["Pickup is included from eligible Marsa Alam-area hotels. The exact pickup time and any remote-area supplement are confirmed after the hotel location is provided.", "The return journey begins at approximately 13:00; whether this is the beach departure time must be confirmed.", "Never touch, feed, chase or disturb turtles or other wildlife.", "Swimming suitability depends on ability, adult supervision, weather and sea conditions.", "Bookings close at 18:00 Africa/Cairo time on the previous day; this precise time is an operational assumption requiring confirmation.", "Child age range must be confirmed before publication."], itinerary: ["Hotel pickup at approximately 07:00", "Arrival at Abu Dabbab Beach at approximately 07:45", "Beach time and independent snorkeling according to conditions", "Return journey begins at approximately 13:00"], whatToBring: ["Passport or photo ID", "Swimwear", "Towel", "Sun protection", "Water", "Personal snorkeling equipment if desired"], notSuitableFor: ["Children without responsible adult supervision", "Guests unable to enter or leave the water safely under the day's conditions"], faqs: [{ question: "Will we see sea turtles?", answer: "Sightings are common but never guaranteed because turtles are wild animals." }, { question: "Is lunch included?", answer: "No. Lunch is not included in the supplied package." }], seoTitle: "Abu Dabbab Beach Snorkeling from Marsa Alam", metaDescription: "Review the Monday, Wednesday and Friday Abu Dabbab Beach snorkeling trip from Marsa Alam with shared transfer and beach entrance. Turtle sightings are not guaranteed."
  },
