...
const tourCatalog: Array<Omit<Tour, "destinationSlug"> & { destinationSlug?: DestinationSlug }> = [
  ...
  },
  {
    ...
    metaDescription: "Book a two-dive guided boat trip for certified divers in Jeddah, exploring wreck and coral sites near Al-Haddad Scuba Shop, for SAR 400 per person including tanks and snacks.",
