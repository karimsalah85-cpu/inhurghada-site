    ...
    <main className="bg-slate-50">
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-10 px-6 py-24 lg:px-8 lg:py-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-slate-200">
              Enjoy a comfortable door-to-door ride to Hurghada’s largest shopping mall with a private driver and flexible pickup times.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm">
                <CarFront size={16} className="text-cyan-300" /> Private vehicle
              </div>
              <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm">
                <Clock3 size={16} className="text-cyan-300" /> Flexible pickup
              </div>
              <div className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm">
                <ShieldCheck size={16} className="text-cyan-300" /> Fixed price
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 rounded-3xl border border-white/10 bg-white/10 p-6 backdrop-blur md:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-2xl font-bold">1 hour</p>
            </div>
            <div>
              <p className="text-sm text-slate-300">Starting rate</p>
              <p className="mt-2 text-2xl font-bold">From $15</p>
            </div>
            <div>
              <p className="text-sm text-slate-300">Booking</p>
              <p className="mt-2 text-2xl font-bold">Pay on arrival</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Whether you are heading to Senzo Mall for shopping, dining, or family time, our transfer service gives you a stress-free way to reach the destination and return comfortably to your hotel or resort.
          </p>
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <div className="flex items-center gap-3 text-cyan-700"><MapPin size={18} /> <span className="font-semibold">Pickup anywhere in Hurghada</span></div>
              <p className="mt-3 text-sm leading-7 text-slate-600">Hotels, resorts, apartments and central points are all supported.</p>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <div className="flex items-center gap-3 text-cyan-700"><Users size={18} /> <span className="font-semibold">Private for your group</span></div>
              <p className="mt-3 text-sm leading-7 text-slate-600">No shared rides, no unnecessary stops, and more space for luggage or shopping bags.</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="rounded-2xl bg-cyan-100 p-3 text-cyan-700"><Sparkles size={20} /></div>
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-cyan-700">Why travelers love it</p>
              <h3 className="text-2xl font-bold text-slate-900">Comfortable and reliable</h3>
            </div>
          </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_0.95fr]">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-5">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Transfer to and from Senzo Mall</h3>
                    <p className="mt-2 text-sm text-slate-600">Private transfer between Senzo Mall and your hotel with fixed prices and professional drivers.</p>
                  </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
                <div className="flex items-center justify-between gap-4">
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Transfer to and from Makadi Bay / Sahl Hasheesh</h3>
                    <p className="mt-2 text-sm text-slate-600">Private transfer to and from Senzo Mall for resorts and hotels in the surrounding areas.</p>
                  </div>
                  <div className="text-right">
                    <p className="text-sm text-slate-500">Starting from</p>
            ...
            <div className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <p className="text-sm font-medium text-slate-600">We will confirm your pickup time and location via WhatsApp before the trip.</p>
              <div className="mt-4 flex items-center gap-2 text-sm font-semibold text-cyan-700">
                <Ticket size={16} /> Book now and confirm instantly
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-700">Booking</p>
            <h2 className="mt-4 text-3xl font-bold text-slate-900">Reserve your transfer in minutes</h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">Fill in the details below and send your request on WhatsApp for a fast confirmation.</p>
            <div className="mt-6 flex items-center gap-3 rounded-2xl bg-slate-50 p-4 text-sm text-slate-600">
              <ShieldCheck className="text-cyan-700" /> No hidden fees. Flexible pickup. Private service.
            </div>
          </div>
      ...
      <section className="border-t border-slate-200 bg-white px-6 py-12">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4 lg:px-8">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-700">More transfers</p>
            <h3 className="mt-2 text-2xl font-bold text-slate-900">Explore other door-to-door routes</h3>
          </div>
          <Link href="/transfers" className="inline-flex items-center gap-2 rounded-full bg-slate-900 px-5 py-3 font-semibold text-white transition hover:bg-slate-700">
            View all transfers <ArrowRight size={16} />
          </Link>
        </div>
      </section>
    </main>
