...
const copy: Record<TermsLocale, { legal: string; title: string; intro: string; back: string; sections: Section[] }> = {
  en: {
    ...
    sections: [
      ...
      { title: "Liability", paragraphs: [
        "Daily Red Sea acts as a booking and coordination agent. We connect travelers with local providers in Hurghada, Marsa Alam and Jeddah, handle bookings and communication, and support guests before, during and after their activity.",
  ...
  de: {
    ...
    sections: [
      ...
      { title: "Haftung", paragraphs: [
        "Daily Red Sea ist als Buchungs- und Koordinationsagentur tätig. Wir vermitteln Reisenden lokale Anbieter in Hurghada, Marsa Alam und Dschidda, übernehmen Buchung und Kommunikation und unterstützen Gäste vor, während und nach der Aktivität.",
  ...
  ru: {
    ...
    sections: [
      ...
      { title: "Ответственность", paragraphs: [
        "Daily Red Sea выступает агентом по бронированию и координации. Мы связываем путешественников с местными поставщиками в Хургаде, Марса-Аламе и Джидде, оформляем бронирования, ведём переписку и поддерживаем гостей до, во время и после мероприятия.",
  ...
  ar: {
    ...
    sections: [
      ...
      { title: "المسؤولية", paragraphs: [
        "تعمل Daily Red Sea كوكيل للحجز والتنسيق، إذ نربط المسافرين بمزودين محليين في الغردقة ومرسى علم وجدة، ونتولى الحجز والتواصل، وندعم الضيوف قبل النشاط وأثناءه وبعده.",
  ...
  zh: {
    ...
    sections: [
      ...
      { title: "责任", paragraphs: [
        "Daily Red Sea 是预订和协调代理，负责将游客与赫尔格达、马萨阿拉姆和吉达的本地服务商对接，处理预订和沟通，并在活动前、活动中和活动后为客人提供支持。",
  ...
  pl: {
    ...
    sections: [
      ...
      { title: "Odpowiedzialność", paragraphs: [
        "Daily Red Sea działa jako agent rezerwacji i koordynacji. Łączymy podróżnych z lokalnymi dostawcami w Hurghadzie, Marsa Alam i Dżuddzie, obsługujemy rezerwacje i komunikację oraz wspieramy gości przed aktywnością, w jej trakcie i po niej.",
