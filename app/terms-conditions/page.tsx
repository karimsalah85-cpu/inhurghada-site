...
const copy: Record<TermsLocale, { legal: string; title: string; intro: string; back: string; sections: Section[] }> = {
  en: {
    ...
    sections: [
      ...
      { title: "Liability", paragraphs: [
        "Daily Red Sea acts as a booking and coordination agent. We connect travelers with local providers in Hurghada, Marsa Alam, El Gouna and Jeddah, handle bookings and communication, and support guests before, during and after their activity.",
        "Each activity is operated by an independent, licensed local provider, such as a boat operator, dive center, safari company or driver. The provider is responsible for safety, equipment, insurance and delivering the service, in line with applicable local regulations.",
        "The provider's own safety rules apply during the activity. Participation in water-based activities (snorkeling, diving, boat trips) and land-based activities (quad biking, desert safaris) carries inherent risk. Guests participate at their own risk and must follow the provider's safety briefing and the instructions of the crew or guide at all times.",
        "Daily Red Sea is not liable for the acts or omissions of providers, for cancellations due to weather or sea conditions, or for injury, loss, illness or damage arising from a guest's failure to follow safety instructions, pre-existing medical conditions not disclosed at booking, or events outside our reasonable control (including natural events, third-party acts or force majeure).",
        "If a provider cancels an activity or it cannot go ahead because of weather or sea conditions, we will help you arrange a refund or rebook another date or activity.",
        "Itineraries, routes and timings may be adjusted by the provider for safety or operational reasons; we'll aim to notify you of significant changes as early as possible.",
  ...
  de: {
    ...
    sections: [
      ...
      { title: "Haftung", paragraphs: [
        "Daily Red Sea ist als Buchungs- und Koordinationsagentur tätig. Wir vermitteln Reisenden lokale Anbieter in Hurghada, Marsa Alam, El Gouna und Dschidda, übernehmen Buchung und Kommunikation und unterstützen Gäste vor, während und nach der Aktivität.",
        "Jede Aktivität wird von einem unabhängigen, lizenzierten lokalen Anbieter durchgeführt, etwa einem Bootsbetreiber, einer Tauchbasis, einem Safariunternehmen oder einem Fahrer. Der Anbieter ist nach den geltenden örtlichen Vorschriften für Sicherheit, Ausrüstung, Versicherung und die Erbringung der Leistung verantwortlich.",
        "Während der Aktivität gelten die Sicherheitsregeln des jeweiligen Anbieters. Wasseraktivitäten wie Schnorcheln, Tauchen und Bootsfahrten sowie Landaktivitäten wie Quadfahren und Wüstensafaris sind mit unvermeidbaren Risiken verbunden. Gäste nehmen auf eigenes Risiko teil und müssen jederzeit die Sicherheitsunterweisung des Anbieters sowie die Anweisungen der Crew oder Reiseleitung befolgen.",
        "Daily Red Sea haftet nicht für Handlungen oder Unterlassungen der Anbieter, für Absagen wegen Wetter- oder Seebedingungen sowie für Verletzungen, Verluste, Erkrankungen oder Schäden, die durch Missachtung von Sicherheitsanweisungen, bei der Buchung nicht angegebene Vorerkrankungen oder Ereignisse außerhalb unseres zumutbaren Einflusses entstehen, einschließlich Naturereignissen, Handlungen Dritter oder höherer Gewalt.",
        "Sagt ein Anbieter eine Aktivität ab oder kann sie wegen Wetter- oder Seebedingungen nicht stattfinden, helfen wir dir bei einer Rückerstattung oder der Umbuchung auf einen anderen Termin oder eine andere Aktivität.",
        "Routen, Ablauf und Zeiten können vom Anbieter aus Sicherheits- oder Betriebsgründen angepasst werden. Über wesentliche Änderungen informieren wir dich so früh wie möglich.",
  ...
  ru: {
    ...
    sections: [
      ...
      { title: "Ответственность", paragraphs: [
        "Daily Red Sea выступает агентом по бронированию и координации. Мы связываем путешественников с местными поставщиками в Хургаде, Марса-Аламе, Эль-Гуне и Джидде, оформляем бронирования, ведём переписку и поддерживаем гостей до, во время и после мероприятия.",
        "Каждое мероприятие проводит независимый лицензированный местный поставщик — лодочный оператор, дайв-центр, сафари-компания или водитель. Поставщик отвечает за безопасность, снаряжение, страхование и оказание услуги в соответствии с применимыми местными нормами.",
        "Во время мероприятия действуют правила безопасности поставщика. Водные мероприятия, включая снорклинг, дайвинг и морские прогулки, а также наземные мероприятия, включая поездки на квадроциклах и сафари, связаны с естественным риском. Гости участвуют на свой риск и обязаны всегда соблюдать инструктаж поставщика и указания экипажа или гида.",
        "Daily Red Sea не несёт ответственности за действия или бездействие поставщиков, за отмены из-за погоды или состояния моря, а также за травмы, утрату имущества, заболевания или ущерб, возникшие из-за несоблюдения инструкций, не сообщённых при бронировании заболеваний либо обстоятельств вне нашего разумного контроля, включая природные явления, действия третьих лиц и форс-мажор.",
        "Если поставщик отменяет мероприятие или оно не может состояться из-за погоды или состояния моря, мы поможем оформить возврат средств или перенести бронирование на другую дату или мероприятие.",
        "Маршрут, программа и время могут быть изменены поставщиком по соображениям безопасности или по операционным причинам. Мы постараемся сообщить о существенных изменениях как можно раньше.",
  ...
  ar: {
    ...
    sections: [
      ...
      { title: "المسؤولية", paragraphs: [
        "تعمل Daily Red Sea كوكيل للحجز والتنسيق، إذ نربط المسافرين بمزودين محليين في الغردقة ومرسى علم والجونة وجدة، ونتولى الحجز والتواصل، وندعم الضيوف قبل النشاط وأثناءه وبعده.",
        "يُنفَّذ كل نشاط بواسطة مزود محلي مستقل ومرخّص، مثل مشغلي القوارب ومراكز الغوص وشركات السفاري والسائقين. ويتحمل المزود مسؤولية السلامة والمعدات والتأمين وتقديم الخدمة وفق اللوائح المحلية المعمول بها.",
        "تسري قواعد السلامة الخاصة بالمزود أثناء النشاط. تنطوي أنشطة الغوص والسنوركلينج والقوارب والكواد والسفاري على مخاطر طبيعية، ويشارك الضيوف على مسؤوليتهم ويلتزمون دائماً بتعليمات السلامة التي يقدمها المزود وطاقمه أو المرشد.",
        "لا تتحمل Daily Red Sea مسؤولية أفعال المزودين أو تقصيرهم، ولا الإلغاء بسبب الطقس أو حالة البحر، ولا الضرر الناتج عن عدم اتباع تعليمات السلامة أو حالة طبية لم يتم الإفصاح عنها عند الحجز أو ظروف خارجة عن سيطرتنا المعقولة مثل الظواهر الطبيعية وأفعال الغير والقوة القاهرة.",
        "إذا ألغى المزود النشاط أو تعذّر تنفيذه بسبب الطقس أو حالة البحر، فسنساعدك في ترتيب استرداد المبلغ أو إعادة الحجز في موعد أو نشاط آخر.",
        "قد يغيّر المزود المسار أو البرنامج أو المواعيد لأسباب تتعلق بالسلامة أو التشغيل، وسنبلغك بالتغييرات المهمة في أقرب وقت.",
  ...
  zh: {
    ...
    sections: [
      ...
      { title: "责任", paragraphs: [
        "Daily Red Sea 是预订和协调代理，负责将游客与赫尔格达、马萨阿拉姆、埃尔古纳和吉达的本地服务商对接，处理预订和沟通，并在活动前、活动中和活动后为客人提供支持。",
        "每项活动均由独立的持牌本地服务商运营，例如游船运营商、潜水中心、沙漠探险公司或司机。服务商须依照适用的当地法规，负责安全、装备、保险及服务的提供。",
        "活动期间适用服务商自身的安全规定。浮潜、潜水、游船、四轮摩托和沙漠探险等活动存在固有风险。参加者自行承担风险，并须始终遵守服务商的安全说明以及船员或导游的指示。",
        "对于服务商的作为或不作为、因天气或海况导致的取消，以及因未遵守安全说明、预订时未披露的既往病史，或超出我们合理控制范围的事件（包括自然事件、第三方行为或不可抗力）造成的伤害、损失、疾病或损害，Daily Red Sea 不承担责任。",
        "如服务商取消活动，或活动因天气或海况无法进行，我们会协助您安排退款，或改订其他日期或活动。",
        "服务商可因安全或运营原因调整路线、行程和时间；我们会尽早通知重大变更。",
        "本条款不排除适用法律规定不得排除的责任。",
      ] },
    ],
  },
  pl: {
    ...
    sections: [
      ...
      { title: "Odpowiedzialność", paragraphs: [
        "Daily Red Sea działa jako agent rezerwacji i koordynacji. Łączymy podróżnych z lokalnymi dostawcami w Hurghadzie, Marsa Alam, El Gounie i Dżuddzie, obsługujemy rezerwacje i komunikację oraz wspieramy gości przed aktywnością, w jej trakcie i po niej.",
        "Każdą aktywność realizuje niezależny, licencjonowany lokalny dostawca, na przykład operator łodzi, centrum nurkowe, firma organizująca safari lub kierowca. Dostawca odpowiada za bezpieczeństwo, sprzęt, ubezpieczenie i realizację usługi zgodnie z obowiązującymi lokalnymi przepisami.",
        "Podczas aktywności obowiązują zasady bezpieczeństwa danego dostawcy. Uczestnictwo w aktywnościach wodnych (snorkeling, nurkowanie, rejsy łodzią) oraz lądowych (jazda quadem, safari po pustyni) wiąże się z nieodłącznym ryzykiem. Goście uczestniczą na własne ryzyko i są zobowiązani zawsze przestrzegać instruktażu bezpieczeństwa dostawcy oraz poleceń załogi lub przewodnika.",
        "Daily Red Sea nie ponosi odpowiedzialności za działania lub zaniechania dostawców, za odwołania z powodu pogody lub warunków na morzu ani za obrażenia, straty, choroby lub szkody wynikające z nieprzestrzegania przez gościa instrukcji bezpieczeństwa, niezgłoszonych przy rezerwacji istniejących wcześniej schorzeń lub zdarzeń pozostających poza naszą uzasadnioną kontrolą (w tym zjawisk naturalnych, działań osób trzecich lub siły wyższej).",
        "Jeśli dostawca odwoła aktywność lub nie może się ona odbyć z powodu pogody lub warunków na morzu, pomożemy zorganizować zwrot środków albo zmianę terminu lub aktywności.",
        "Trasy, przebieg i godziny mogą zostać zmienione przez dostawcę z przyczyn bezpieczeństwa lub operacyjnych; dołożymy starań, aby jak najwcześniej informować o istotnych zmianach.",
