...
export default async function LocalizedPage({ params }: LocalizedPageProps) {
  ...
  if (kind === "category") {
    ...
    const relatedDivingCopy = { title: "Odkryj nurkowanie i snorkeling w Hurghadzie", text: "Porównaj wycieczki z przewodnikiem — od pierwszego nurkowania po całodniowe wyprawy na rafy.", cta: "Odkryj nurkowanie i snorkeling" };
