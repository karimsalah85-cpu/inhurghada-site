...
const mediaBySlug: Record<string, SafeMedia> = {
  ...
  "el-gouna-city-boat-tour": categoryMedia.elGouna, "turkish-bath-spa": { image: "/images/owned/red-sea-coast.jpg", alt: localizedAlt("Calm Red Sea coastline near Hurghada") },
