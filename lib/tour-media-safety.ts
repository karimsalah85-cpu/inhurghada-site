...
const mediaBySlug: Record<string, SafeMedia> = {
  ...
  "jeddah-yacht-sunset-cruise": {
    ...
    alt: {
      en: "Shorouk Sat yacht cruising through Jeddah's Obhur Bay at sunset",
      ar: "يخت شروق سات يبحر في خليج أبحر بجدة وقت الغروب",
      de: "Die Yacht Shorouk Sat fährt bei Sonnenuntergang durch Jeddahs Obhur Bay",
      ru: "Яхта Shorouk Sat плывёт по бухте Обхур в Джидде на закате",
      pl: "Jacht Shorouk Sat płynący przez zatokę Obhur w Dżuddzie o zachodzie słońca",
      zh: "Shorouk Sat游艇在日落时分航行于吉达奥布尔湾",
    },
    focal: { x: 0.53, y: 0.5 },
  },
  "bayada-snorkeling-trip-jeddah": {
    ...
    alt: {
      en: "Snorkeler giving peace signs underwater above a Red Sea reef near Jeddah",
      ar: "شخص يمارس السنوركلينج ويشير بإشارة النصر تحت الماء فوق شعاب البحر الأحمر قرب جدة",
      de: "Schnorchler zeigt unter Wasser das Peace-Zeichen über einem Riff im Roten Meer bei Dschidda",
      ru: "Сноркелер показывает знак мира под водой над рифом Красного моря недалеко от Джидды",
      pl: "Osoba nurkująca z rurką pokazuje pod wodą znak pokoju nad rafą Morza Czerwonego koło Dżuddy",
      zh: "浮潜者在吉达附近红海礁石上方水下比出胜利手势",
    },
    focal: { x: 0.5, y: 0.4 },
    gallery: ["/images/owned/jeddah-bayada-family-snorkeling.jpg"],
    galleryAlts: {
      en: ["Family snorkeling together over a coral reef in the clear Red Sea"],
      ar: ["عائلة تمارس السنوركلينج معًا فوق شعاب مرجانية في مياه البحر الأحمر الصافية"],
      de: ["Familie schnorchelt gemeinsam über einem Korallenriff im klaren Roten Meer"],
      ru: ["Семья вместе занимается сноркелингом над коралловым рифом в прозрачном Красном море"],
      pl: ["Rodzina nurkująca razem z rurką nad rafą koralową w przejrzystym Morzu Czerwonym"],
      zh: ["一家人在清澈的红海中一起在珊瑚礁上方浮潜"],
    },
  },
  ...
  "horse-riding-el-gouna": {
    ...
    alt: {
      en: "Two smiling riders on a chestnut and a grey horse wading through turquoise Red Sea water in El Gouna",
      ar: "راكبتان مبتسمتان على حصان كستنائي وحصان رمادي تخوضان مياه البحر الأحمر الفيروزية في الجونة",
      de: "Zwei lächelnde Reiterinnen auf einem Fuchs und einem Schimmel im türkisfarbenen Roten Meer in El Gouna",
      ru: "Две улыбающиеся всадницы на рыжей и серой лошадях в бирюзовой воде Красного моря в Эль-Гуне",
      pl: "Dwie uśmiechnięte amazonki na kasztanowatym i siwym koniu w turkusowej wodzie Morza Czerwonego w El Gounie",
      zh: "两位面带笑容的骑手骑着栗色马和灰马，在埃尔古纳碧绿的红海海水中涉水前行",
    },
    focal: { x: 0.5, y: 0.6 },
    gallery: ["/images/owned/el-gouna-horse-riding-desert-sunset.jpg", "/images/owned/el-gouna-horse-riding-sea-swim.jpg", "/images/owned/el-gouna-horse-riding-beach-walk.jpg"],
    galleryAlts: {
      en: ["Riders in helmets on a guided group horse ride across the desert near El Gouna in golden evening light", "Two riders sitting on grey horses standing in the shallow Red Sea", "A rider in a helmet walking a skewbald horse along the wet shoreline, its reflection in the water"],
      ar: ["راكبون يرتدون الخوذات في جولة جماعية بصحبة مرشد على ظهور الخيل عبر الصحراء قرب الجونة في ضوء المساء الذهبي", "راكبتان على حصانين رماديين يقفان في مياه البحر الأحمر الضحلة", "راكبة ترتدي خوذة تسير بحصان مرقط على طول الشاطئ المبلل وانعكاسه على الماء"],
      de: ["Reiter mit Helmen bei einem geführten Gruppenausritt durch die Wüste bei El Gouna im goldenen Abendlicht", "Zwei Reiterinnen auf Schimmeln im flachen Wasser des Roten Meeres", "Eine Reiterin mit Helm führt ein Schecken-Pferd im Schritt über den nassen Strand, das sich im Wasser spiegelt"],
      ru: ["Всадники в шлемах на групповой прогулке с гидом по пустыне у Эль-Гуны в золотом вечернем свете", "Две всадницы на серых лошадях на мелководье Красного моря", "Всадница в шлеме шагом едет на пегой лошади по влажному берегу, отражаясь в воде"],
      pl: ["Jeźdźcy w kaskach podczas grupowej przejażdżki z przewodnikiem po pustyni koło El Gouny w złotym wieczornym świetle", "Dwie amazonki na siwych koniach w płytkiej wodzie Morza Czerwonego", "Amazonka w kasku jedzie stępem na srokatym koniu po mokrym brzegu, a koń odbija się w wodzie"],
      zh: ["骑手们戴着头盔，在金色傍晚光线下跟随向导穿越埃尔古纳附近的沙漠", "两位骑手坐在灰马上，站在红海浅水中", "一位戴头盔的骑手骑着花斑马沿湿润的海岸缓行，倒影映在水中"],
    },
  },
