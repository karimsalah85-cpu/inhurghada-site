...
const mediaBySlug: Record<string, SafeMedia> = {
  ...
  "bayada-snorkeling-trip-jeddah": {
    ...
    alt: {
      en: "Snorkeler exploring a coral reef in clear Red Sea water near Jeddah",
      ar: "شخص يمارس السنوركلينج فوق شعاب مرجانية في مياه صافية بالبحر الأحمر قرب جدة",
      de: "Schnorchler an einem Korallenriff im klaren Wasser des Roten Meeres bei Dschidda",
      ru: "Сноркелер у кораллового рифа в прозрачной воде Красного моря недалеко от Джидды",
      pl: "Osoba nurkująca z rurką nad rafą koralową w przejrzystej wodzie Morza Czerwonego koło Dżuddy",
      zh: "浮潜者在吉达附近清澈的红海水域探索珊瑚礁",
    },
    gallery: ["/images/owned/red-sea-coral-closeup.jpg", "/images/owned/red-sea-coast.jpg"],
    galleryAlts: {
      en: ["Red Sea coral with small reef fish", "Clear shallow Red Sea water along the coast"],
      ar: ["مرجان البحر الأحمر مع أسماك شعاب صغيرة", "مياه ضحلة صافية على ساحل البحر الأحمر"],
      de: ["Korallen im Roten Meer mit kleinen Rifffischen", "Klares flaches Wasser des Roten Meeres an der Küste"],
      ru: ["Кораллы Красного моря с мелкими рифовыми рыбами", "Прозрачная мелкая вода Красного моря у берега"],
      pl: ["Koralowce Morza Czerwonego z małymi rybami rafowymi", "Przejrzysta płytka woda Morza Czerwonego przy brzegu"],
      zh: ["红海珊瑚与小型礁鱼", "海岸边清澈的红海浅水"],
    },
  },
