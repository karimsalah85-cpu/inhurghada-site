          ...
          <div className="grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="rounded-3xl border border-white/10 bg-white p-8 text-slate-900 shadow-2xl">
              ...
              <div className="mt-8 space-y-4">
                <a href={`https://wa.me/${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "201004933150"}?text=Hi%20Daily%20Red%20Sea%2C%20I%20need%20help%20with%20my%20booking`} onClick={() => trackEvent("whatsapp_click", { placement: "booking_portal" })} target="_blank" rel="noreferrer" className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-400">
                ...
                <a href={`mailto:${process.env.NEXT_PUBLIC_CONTACT_EMAIL || "info@dailyredsea.com"}`} onClick={() => trackEvent("email_click", { placement: "booking_portal" })} className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-400">
                ...
                <a href={`tel:+${process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "201004933150"}`} onClick={() => trackEvent("phone_click", { placement: "booking_portal" })} className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 transition hover:border-cyan-400"><span className="flex items-center gap-3 font-semibold text-slate-900"><Smartphone className="text-cyan-700" /> Call us</span><span className="text-sm text-slate-500">+20 100 493 3150</span></a>
              </div>
            </div>
          </div>
        </div>
