...
export default function BookingForm({ tourName, tourSlug, price, originalPrice, duration, location, participantPricing, availableTimes, ageBands }: BookingFormProps) {
