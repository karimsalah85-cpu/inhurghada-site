  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl sm:p-7">
      ...
      {step === "select" ? <>
        ...
        <label className="block text-sm font-bold">Pickup location <span className="font-normal text-slate-500">(optional)</span><div className="relative mt-1"><Hotel className="absolute left-3 top-3 text-slate-400" size={18}/><input value={hotel} onChange={(event) => setHotel(event.target.value)} className="w-full rounded-xl border py-3 pl-10 pr-3 font-normal" placeholder="Hotel name or address" /></div></label>
