  ...
  return (
    <main className="min-h-screen bg-slate-50 px-6 pb-20 pt-32 sm:px-8">
      <article className="mx-auto max-w-5xl">
        <p className="font-semibold uppercase tracking-[0.28em] text-cyan-700">{tr("Local help on the Red Sea", "Lokale Hilfe am Roten Meer", "Местная помощь на Красном море")}</p>
