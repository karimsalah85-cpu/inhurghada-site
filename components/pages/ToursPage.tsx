...
type ToursPageProps = { searchParams?: Promise<{ search?: string; destination?: string }> };

export async function ToursPage({ locale = "en", searchParams }: ToursPageProps & { locale?: Locale }) {
...
export default function Page(props: ToursPageProps) {
