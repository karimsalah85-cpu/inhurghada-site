          ...
          >
            ...
            {showManualBooking ? (
              <form onSubmit={createManualBooking} className="mt-5 grid gap-3 rounded-2xl border border-cyan-200 bg-cyan-50 p-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <select name="currency" aria-label="Currency" defaultValue="USD" className="rounded-xl border border-slate-200 bg-white px-3 py-2.5"><option>USD</option><option>EUR</option><option>GBP</option><option>EGP</option><option>SAR</option></select>
