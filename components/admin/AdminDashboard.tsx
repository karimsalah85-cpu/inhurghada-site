...
export default function AdminDashboard({ initialBookings, initialExpenses, initialSuppliers, initialSalesPeople, migrationPending = false }: { initialBookings: Booking[]; initialExpenses: Expense[]; initialSuppliers: Supplier[]; initialSalesPeople: SalesPerson[]; migrationPending?: boolean }) {
  ...
  return <>
    <div className="mt-7 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white p-3 shadow-sm">
      <nav aria-label="Admin sections" className="flex flex-wrap gap-1 text-sm font-bold"><a href="#bookings" className="rounded-lg px-3 py-2 hover:bg-slate-100">Bookings</a><a href="#expenses" className="rounded-lg px-3 py-2 hover:bg-slate-100">Expenses</a><a href="#google-ads" className="rounded-lg px-3 py-2 hover:bg-slate-100">Google Ads</a><a href="#partners" className="rounded-lg px-3 py-2 hover:bg-slate-100">Suppliers & sales</a><a href="#reports" className="rounded-lg px-3 py-2 hover:bg-slate-100">Reports</a></nav>
