...
export default function AdminControlCenter() {
  ...
  return <section id="control-center" className="mt-8 scroll-mt-6 rounded-3xl bg-white p-5 shadow-sm sm:p-6">
    ...
    {data?.configured && tab === "content" ? <TripStatusPanel items={data.content.filter((item) => item.content_type === "tour" && item.locale === "en")} busy={busy} update={updateTripStatus}/> : null}
