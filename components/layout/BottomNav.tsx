...
/** The tour slug when the current page is a tour's own detail page, where TourBookingBar replaces the generic nav. */
...
export default function BottomNav() {
  ...
  // Tour detail pages render their own TourBookingBar from the live (CMS-merged)
  // tour, so its price always matches the booking form. Step aside so the two
  // never stack or compete for attention.
  if (currentTourSlug(pathname, language)) return null;
