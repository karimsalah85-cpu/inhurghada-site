...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    explore: "Explore", myTrips: "My Trips", plan: "Plan", planYourTrip: "Plan your trip", quickNavigation: "Quick navigation", bookThisTrip: "Book this trip", from: "From",
    discoverHurghada: "Discover the Red Sea", heroTitle: "Discover Red Sea Tours & Experiences", heroDescription: "Verified Red Sea trips with clear prices and easy WhatsApp booking.",
    privateTransfers: "Private transfers", boatTrips: "Boat trips & snorkeling", desertAdventures: "Desert adventures", destination: "Destination", destinationQuestion: "Where do you want to go?", travelDate: "Travel Date", guests: "Guests", searchTours: "Search tours",
  ...
  ar: {
    ...
    explore: "استكشف", myTrips: "رحلاتي", plan: "خطط", planYourTrip: "خطط رحلتك", quickNavigation: "التنقل السريع", bookThisTrip: "احجز هذه الرحلة", from: "ابتداءً من",
    discoverHurghada: "اكتشف البحر الأحمر", heroTitle: "تجارب البحر الأحمر، وجهة بعد أخرى", heroDescription: "رحلات موثوقة على البحر الأحمر بأسعار واضحة وحجز سهل عبر واتساب.",
    privateTransfers: "تنقلات خاصة", boatTrips: "رحلات بحرية وغطس", desertAdventures: "مغامرات صحراوية", destination: "الوجهة", destinationQuestion: "إلى أين تريد الذهاب؟", travelDate: "تاريخ الرحلة", guests: "الضيوف", searchTours: "ابحث عن رحلة",
  ...
  de: {
    ...
    explore: "Entdecken", myTrips: "Meine Reisen", plan: "Planen", planYourTrip: "Reise planen", quickNavigation: "Schnellnavigation", bookThisTrip: "Diesen Ausflug buchen", from: "Ab",
    discoverHurghada: "Entdecke das Rote Meer", heroTitle: "Erlebnisse am Roten Meer – Reiseziel für Reiseziel", heroDescription: "Geprüfte Ausflüge am Roten Meer mit klaren Preisen und einfacher WhatsApp-Buchung.",
    privateTransfers: "Private Transfers", boatTrips: "Bootstouren & Schnorcheln", desertAdventures: "Wüstenabenteuer", destination: "Reiseziel", destinationQuestion: "Wohin möchtest du?", travelDate: "Reisedatum", guests: "Gäste", searchTours: "Ausflüge suchen",
  ...
  ru: {
    ...
    explore: "Исследовать", myTrips: "Мои поездки", plan: "План", planYourTrip: "Спланировать поездку", quickNavigation: "Быстрая навигация", bookThisTrip: "Забронировать поездку", from: "От",
    discoverHurghada: "Откройте Красное море", heroTitle: "Впечатления Красного моря — направление за направлением", heroDescription: "Проверенные поездки по Красному морю с понятными ценами и удобным бронированием в WhatsApp.",
    privateTransfers: "Частные трансферы", boatTrips: "Морские прогулки и сноркелинг", desertAdventures: "Приключения в пустыне", destination: "Направление", destinationQuestion: "Куда вы хотите поехать?", travelDate: "Дата поездки", guests: "Гости", searchTours: "Найти туры",
  ...
  pl: {
    ...
    explore: "Odkrywaj", myTrips: "Moje podróże", plan: "Plan", planYourTrip: "Zaplanuj podróż", quickNavigation: "Szybka nawigacja", bookThisTrip: "Zarezerwuj tę wycieczkę", from: "Od",
    discoverHurghada: "Odkryj Morze Czerwone", heroTitle: "Atrakcje Morza Czerwonego — kierunek po kierunku", heroDescription: "Sprawdzone wycieczki nad Morzem Czerwonym z jasnymi cenami i łatwą rezerwacją przez WhatsApp.",
    privateTransfers: "Prywatne transfery", boatTrips: "Rejsy i snorkeling", desertAdventures: "Przygody na pustyni", destination: "Kierunek", destinationQuestion: "Dokąd chcesz jechać?", travelDate: "Data podróży", guests: "Goście", searchTours: "Szukaj wycieczek",
  ...
  zh: {
    ...
    explore: "探索", myTrips: "我的行程", plan: "计划", planYourTrip: "规划行程", quickNavigation: "快速导航", bookThisTrip: "预订此行程", from: "起价",
    discoverHurghada: "探索红海", heroTitle: "逐个目的地，发现红海精彩体验", heroDescription: "红海精选行程，价格透明，WhatsApp 预订便捷。",
    privateTransfers: "私人接送", boatTrips: "游船和浮潜", desertAdventures: "沙漠探险", destination: "目的地", destinationQuestion: "您想去哪里？", travelDate: "出行日期", guests: "游客", searchTours: "搜索旅游项目",
