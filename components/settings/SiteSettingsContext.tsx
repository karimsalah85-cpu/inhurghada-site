...
const translations: Record<Language, Record<string, string>> = {
  ...
  de: {
    ...
    chooseExperience: "Wähle dein Erlebnis", exploreAdventure: "Entdecke Hurghada als Abenteuer", viewAllTours: "Alle Ausflüge ansehen", popularTours: "Beliebte Ausflüge", popularToursDescription: "Entdecke Tauchgänge, Schnorcheln, Orange-Bay-Kreuzfahrten und Abenteuer im Roten Meer.", searchPlaceholder: "Ausflüge, Orte oder Aktivitäten suchen...", bestSeller: "Bestseller", everyDay: "Täglich", perPerson: "pro Person",
  },
};
