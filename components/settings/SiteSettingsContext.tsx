...
const translations: Record<Language, Record<string, string>> = {
  en: {
    home: "Home", tours: "Tours", transfers: "Transfers", booking: "Booking", checkout: "Checkout", about: "About", bookNow: "Book Now", whatsappBooking: "WhatsApp Booking", goodMorning: "Good morning", goodAfternoon: "Good afternoon", goodEvening: "Good evening", navSearch: "Search tours", navSearchPlaceholder: "Search tours, places, activities...",
  ...
  ar: {
    home: "الرئيسية", tours: "الرحلات", transfers: "التنقلات", booking: "الحجوزات", checkout: "إتمام الحجز", about: "من نحن", bookNow: "احجز الآن", whatsappBooking: "الحجز عبر واتساب", goodMorning: "صباح الخير", goodAfternoon: "مساء الخير", goodEvening: "مساء الخير", navSearch: "ابحث عن رحلة", navSearchPlaceholder: "ابحث عن رحلات أو مواقع أو أنشطة...",
  ...
  de: {
    home: "Startseite", tours: "Ausflüge", transfers: "Transfers", booking: "Buchung", checkout: "Kasse", about: "Über uns", bookNow: "Jetzt buchen", whatsappBooking: "WhatsApp-Buchung", goodMorning: "Guten Morgen", goodAfternoon: "Guten Tag", goodEvening: "Guten Abend", navSearch: "Ausflüge suchen", navSearchPlaceholder: "Ausflüge, Orte, Aktivitäten suchen...",
  ...
  ru: {
    home: "Главная", tours: "Экскурсии", transfers: "Трансферы", booking: "Бронирование", checkout: "Оформление", about: "О нас", bookNow: "Забронировать", whatsappBooking: "Бронирование в WhatsApp", goodMorning: "Доброе утро", goodAfternoon: "Добрый день", goodEvening: "Добрый вечер", navSearch: "Найти туры", navSearchPlaceholder: "Поиск туров, мест и занятий...",
  ...
  pl: {
    home: "Strona główna", tours: "Wycieczki", transfers: "Transfery", booking: "Rezerwacja", checkout: "Finalizacja", about: "O nas", bookNow: "Zarezerwuj", whatsappBooking: "Rezerwacja przez WhatsApp", goodMorning: "Dzień dobry", goodAfternoon: "Dzień dobry", goodEvening: "Dobry wieczór", navSearch: "Szukaj wycieczek", navSearchPlaceholder: "Szukaj wycieczek, miejsc i atrakcji...",
  ...
  zh: {
    home: "首页", tours: "旅游项目", transfers: "接送服务", booking: "预订", checkout: "结算", about: "关于我们", bookNow: "立即预订", whatsappBooking: "WhatsApp 预订", goodMorning: "早上好", goodAfternoon: "下午好", goodEvening: "晚上好", navSearch: "搜索旅游项目", navSearchPlaceholder: "搜索旅游项目、地点或活动...",
